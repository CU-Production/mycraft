...
/*
    ...
    Shader program: 'block':
        ...
        Vertex Shader: block_vs
        Fragment Shader: block_fs
        Attributes:
...
*/
static const uint8_t block_vs_source_glsl410[1221] = {
...
*/
static const uint8_t block_fs_source_glsl410[1739] = {
    0x23,0x76,0x65,0x72,0x73,0x69,0x6f,0x6e,0x20,0x34,0x31,0x30,0x0a,0x0a,0x73,0x74,
...
*/
static const uint8_t block_vs_source_hlsl5[2135] = {
...
*/
static const uint8_t block_fs_source_hlsl5[2651] = {
...
*/
static const uint8_t block_vs_source_metal_macos[1554] = {
...
*/
static const uint8_t block_fs_source_metal_macos[2080] = {
    0x23,0x69,0x6e,0x63,0x6c,0x75,0x64,0x65,0x20,0x3c,0x6d,0x65,0x74,0x61,0x6c,0x5f,
    0x73,0x74,0x64,0x6c,0x69,0x62,0x3e,0x0a,0x23,0x69,0x6e,0x63,0x6c,0x75,0x64,0x65,
    0x20,0x3c,0x73,0x69,0x6d,0x64,0x2f,0x73,0x69,0x6d,0x64,0x2e,0x68,0x3e,0x0a,0x0a,
    0x75,0x73,0x69,0x6e,0x67,0x20,0x6e,0x61,0x6d,0x65,0x73,0x70,0x61,0x63,0x65,0x20,
...
*/
static const uint8_t block_vs_source_wgsl[2078] = {
...
*/
static const uint8_t block_fs_source_wgsl[2905] = {
    0x64,0x69,0x61,0x67,0x6e,0x6f,0x73,0x74,0x69,0x63,0x28,0x6f,0x66,0x66,0x2c,0x20,
    0x64,0x65,0x72,0x69,0x76,0x61,0x74,0x69,0x76,0x65,0x5f,0x75,0x6e,0x69,0x66,0x6f,
    0x72,0x6d,0x69,0x74,0x79,0x29,0x3b,0x0a,0x0a,0x73,0x74,0x72,0x75,0x63,0x74,0x20,
...
static inline const sg_shader_desc* block_shader_desc(sg_backend backend) {
    if (backend == SG_BACKEND_GLCORE) {
        ...
        if (!valid) {
            valid = true;
            desc.vertex_func.source = (const char*)block_vs_source_glsl410;
            desc.vertex_func.entry = "main";
            desc.fragment_func.source = (const char*)block_fs_source_glsl410;
    ...
    if (backend == SG_BACKEND_D3D11) {
        ...
        if (!valid) {
            valid = true;
            desc.vertex_func.source = (const char*)block_vs_source_hlsl5;
            desc.vertex_func.d3d11_target = "vs_5_0";
            desc.vertex_func.entry = "main";
            desc.fragment_func.source = (const char*)block_fs_source_hlsl5;
    ...
    if (backend == SG_BACKEND_METAL_MACOS) {
        ...
        if (!valid) {
            valid = true;
            desc.vertex_func.source = (const char*)block_vs_source_metal_macos;
            desc.vertex_func.entry = "main0";
            desc.fragment_func.source = (const char*)block_fs_source_metal_macos;
    ...
    if (backend == SG_BACKEND_WGPU) {
        ...
        if (!valid) {
            valid = true;
            desc.vertex_func.source = (const char*)block_vs_source_wgsl;
            desc.vertex_func.entry = "main";
            desc.fragment_func.source = (const char*)block_fs_source_wgsl;
            desc.fragment_func.entry = "main";
            desc.attrs[0].base_type = SG_SHADERATTRBASETYPE_FLOAT;
            desc.attrs[1].base_type = SG_SHADERATTRBASETYPE_FLOAT;
            desc.attrs[2].base_type = SG_SHADERATTRBASETYPE_FLOAT;
